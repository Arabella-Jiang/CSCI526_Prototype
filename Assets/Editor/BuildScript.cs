...
public class BuildScript
{
    ...
    public static void BuildWebGLNoCompression()
    {
        ...
        // Set other WebGL settings for better compatibility
        PlayerSettings.WebGL.linkerTarget = WebGLLinkerTarget.Wasm;
        PlayerSettings.WebGL.memorySize = 256;
        
        // Build settings
        string[] scenes = { "Assets/Scenes/1.unity" };
        ...
        Debug.Log("Starting WebGL build with compression disabled...");
    ...
    private static void CreateIndexHTML(string buildPath)
    {
        string projectName = PlayerSettings.productName.Replace(" ", "");
        if (string.IsNullOrEmpty(projectName))
        {
            projectName = "UnityGame";
        }
...
<html lang=""en-us"">
  <head>
    ...
    <title>{PlayerSettings.productName}</title>
  ...
  <body>
    <div id=""unity-container"" class=""unity-desktop"">
      ...
      <div id=""unity-footer"">
        ...
        <div id=""unity-build-title"">{PlayerSettings.productName}</div>
      </div>
    </div>
    <script>
